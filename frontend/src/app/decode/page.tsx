...
import { UploadCloud, FileAudio, CheckCircle2, Eye, EyeOff, Play, Pause, Volume2, VolumeX, AlertTriangle } from "lucide-react";
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
                ...
                {audioFile && (
                  <div className="mt-5 flex items-center gap-3 relative z-20">
                    <button
                      ...
                      className="rounded-lg bg-white/5 border border-white/10 px-4 py-2.5 text-xs font-semibold text-slate-300 hover:bg-red-500/10 hover:border-red-500/20 hover:text-red-400 transition focus-visible:ring-2 focus-visible:ring-red-400 outline-none min-h-[44px] lg:min-h-0 flex items-center justify-center"
                    >
                      Remove
                    </button>
                    <label
                      htmlFor="decode-audio"
                      className="rounded-lg bg-[#1bd6d1] px-4 py-2.5 text-xs font-semibold text-black hover:brightness-110 transition cursor-pointer flex items-center justify-center min-h-[44px] lg:min-h-0 focus-visible:ring-2 focus-visible:ring-cyan-400 outline-none"
                    >
                      Change File
                    </label>
                  </div>
            ...
            {localError && (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-1 text-xs text-red-400/80 whitespace-pre-line">{localError}</p>
                </div>
              </div>
            )}
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="rounded-3xl border border-white/10 bg-[#0b1327] p-6">
              ...
              {error && (
                <div role="alert" className="rounded-xl border border-red-500/30 bg-red-500/10 p-4 text-sm text-red-400 flex items-start gap-3 transition-all duration-300">
                  <AlertTriangle size={18} className="shrink-0 mt-0.5" />
                  <div className="flex-1">
              ...
              {localResult && (
                <div className="space-y-4">
                  <div className="rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-4 text-sm text-emerald-400 flex items-start gap-3 transition-all duration-300">
                    <CheckCircle2 size={18} className="shrink-0 mt-0.5" />
                    <div className="flex-1">
                      <p className="font-semibold">Decoding Complete</p>
                      <p className="mt-1 text-xs text-emerald-400/80">Message extracted successfully from secure container.</p>
                    </div>
                  </div>
